...
def ask_health_question(patientId: str, question: str):
    ...
    prompt = f"""
            ...
            1)
            - 질문: "최근 건강검진 결과는 어때요?"
            - 답변: "8월 15일 건강검진 결과입니다. BMI 23.5로 정상, 혈당 95mg/dL로 정상 범위에 있습니다. 다만 혈압이 125/82로 약간 높은 편이니 염분 섭취를 줄이시길 권합니다."
            
            2)
            - 질문: "콜레스테롤 수치가 어때요?"
            - 답변: "총 콜레스테롤 190mg/dL로 정상 범위(200 미만)입니다. HDL 60mg/dL도 우수한 수준이네요. 현재 상태를 유지하시면 됩니다."
            """
